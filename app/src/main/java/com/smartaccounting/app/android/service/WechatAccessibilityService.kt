...
class WechatAccessibilityService : AccessibilityService() {
    ...
    companion object {
        const val TAG = "WechatAccessibility"
    ...
    override fun onAccessibilityEvent(event: AccessibilityEvent?) {
        ...
        if (className.contains("PayComfirmActivity") || className.contains("WalletPaySucc")) {
    ...
    private fun extractPaymentInfo(rootNode: AccessibilityNodeInfo?) {
        ...
        try {
            ...
            if (amount != null) {
                ...
                showFloatingWindow(amount!!, merchantName ?: "微信商户", "wechat", transactionTime)
            }
        } finally {
            rootNode.recycle()
        }
